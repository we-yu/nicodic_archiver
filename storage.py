...
def list_queue_requests(conn, limit=None):
    """Return queued requests in enqueue order."""
...
def remove_queue_request(conn, article_id, article_type):
    """Remove one queued request after a success-class terminal outcome."""
